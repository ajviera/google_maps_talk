## Google Maps Talk UI package

Google Maps Talk UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── google_maps_talk_icons_dark.dart
│   │       │      ├── google_maps_talk_icons_light.dart
│   │       │      └── google_maps_talk_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── google_maps_talk_app_bar.dart
│   │             ├── google_maps_talk_outlined_button.dart
│   │             └── google_maps_talk_text_field.dart 
│   ├── google_maps_talk_ui.dart
│   ├── .gitignore
...
1) Inside `google_maps_talk_icons.dart`:
...
```
2) In `google_maps_talk_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `google_maps_talk_icons_dark.dart` add the icon with its color respectively of the theme. 
